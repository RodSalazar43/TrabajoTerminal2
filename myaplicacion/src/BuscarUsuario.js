...
import ModificaUsuario from './ModificaUsuario';
    ...
    informacionDeUsuario(event){
        ...
        const muestraNuevo=this.state.usuario;
            if(muestraNuevo===false){
                profesor ? ReactDOM.render(<ModificaUsuario />,profesor ): false; //simplemente tomo otro div del index.html para mostrar esto
            ...
            <center className="container bg-success">
                ...
                <form onSubmit={this.handleSubmit}>
                    <div className="container">
                        <div className="row">
                            <div className="col-4">
                                <label className="font-weight-bold text-white h5">Ingresa el id del usuario a modificar: </label>
                            </div>
                            <div className="col-8">
                                <input className="form-control" type="text" placeholder="Identificador del usuario" name="id" onChange={this.handleId} value={this.state.id} required></input>
                            </div>
                        </div>
                        <br></br>
                        <div className="row">
                            <div className="col">
                                <input className="btn btn-warning btn-lg btn-block" type="submit" value="Buscar"></input>
                            </div>
                        </div>
                        <br></br>
                    </div>
